 ...
 */
public class FetchedEntityReturn extends AbstractFetchReturn implements EntityReturn {
	private final String sqlTableAlias;
	private final EntityAliases entityAliases;

	private final EntityPersister persister;

	public FetchedEntityReturn(
		...
		super( sessionFactory, alias, lockMode, owner, ownerProperty );
