...
/**
 * Represents a return which names a collection role; it is used in defining a custom query for loading an entity's
 * collection in non-fetching scenarios (i.e., loading the collection itself as the "root" of the result).
 *
 * @author Steve Ebersole
 */
public class RootCollectionReturn extends AbstractFetchOwner implements RootReturn, CollectionReturn {
